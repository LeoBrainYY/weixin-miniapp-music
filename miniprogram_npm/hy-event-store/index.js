...
__DEFINE__(1670173996670, function(require, module, exports) {
module.exports = {
  HYEventBus: require('./event-bus'),
  HYEventStore: require('./event-store')
}

}, function(modId) {var map = {"./event-bus":1670173996671,"./event-store":1670173996672}; return __REQUIRE__(map[modId], modId); })
__DEFINE__(1670173996671, function(require, module, exports) {
class HYEventBus {
  constructor() {
    this.eventBus = {}
  }
...
__DEFINE__(1670173996672, function(require, module, exports) {
...
}, function(modId) { var map = {"./event-bus":1670173996671,"./utils":1670173996673}; return __REQUIRE__(map[modId], modId); })
__DEFINE__(1670173996673, function(require, module, exports) {
...
return __REQUIRE__(1670173996670);
})()
